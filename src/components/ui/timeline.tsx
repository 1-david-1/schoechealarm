    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl">
          ...
          zu einem etablierten Sicherheitsunternehmen im Vogtland entwickelt. 
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-[hsl(var(--amber))] via-[hsl(var(--amber))] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
