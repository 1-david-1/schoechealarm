    ...
    <section className="py-16 bg-background">
      <div className="container-tight">
        ...
        <div className="max-w-2xl mx-auto">
          <a 
            href="https://www.google.com/maps/place/Sch%C3%B6che+Alarm-+und+Sicherheitstechnik/@50.2911111,12.2516667,17z/data=!4m8!3m7!1s0x47a0f1234567890:0x1234567890abcdef!8m2!3d50.2911111!4d12.2516667!9m1!1b1!16s%2Fg%2F1234567890"
            target="_blank"
            rel="noopener noreferrer"
            className="block bg-card rounded-2xl p-8 border border-border hover:border-accent/30 hover:shadow-medium transition-all duration-300 group"
          >
