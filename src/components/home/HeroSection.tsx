    ...
    <section className="relative gradient-hero overflow-hidden pt-8 pb-16">
      ...
      <ContainerScroll
        titleComponent={
          <>
            ...
            <div className="flex flex-col items-center space-y-5 md:space-y-6 max-w-3xl mx-auto mb-16">
      ...
      >
        <div className="relative w-full h-full flex items-center bg-black">
          <div className="rounded-3xl overflow-hidden shadow-glow ring-1 ring-white/10 w-full h-full">
            <img
          ...
          <div className="absolute -top-4 -right-2 md:-right-8 bg-accent text-accent-foreground px-5 py-3 rounded-2xl shadow-glow">
